...
const commands = [
    {   // report: [USERNAME, REASON, ATTACHMENTS (optional)]
        ...
        options: [{
            // NUMBER
            name: "number",
            description: "Specify quote number (default = RANDOM)",
            type: ApplicationCommandOptionType.Integer,
            required: false
        }]
    ...
    },{ // REMIND-ME: [REMINDER, MONTH, DAY, YEAR (optional), TIME (optional), PRIVATE (optional, boolean)] ...
        name: "remind-me",
        description: "Ask me to remind you of something :)",
        options:[{
            // REMINDER
            name: "reminder",
            ...
            // MONTH
            name: "month",
            description: "Month to be reminded in",
            type: ApplicationCommandOptionType.Integer,
            required: true,
            choices: [
                { name: "1. January"   , value: 1 },
            ...
            // DAY
            name: "day",
            description: "Which day of the month is the reminder?",
            type: ApplicationCommandOptionType.Integer,
            required: true
        },{
            // YEAR
            name: "year",
            description: "What year is the reminder? (optional)",
            type: ApplicationCommandOptionType.Integer,
            required: false
        },{
            // TIME
            name: "time",
            description: "Time to be reminded in",
            type: ApplicationCommandOptionType.Integer,
            required: false,
            choices: [
            ...
            // PRIVATE
            name: "private",
            description: "Set as private reminder",
        ...
        name: "algo",
        description: "Algo and Rythm are brothers. OFFICERS ONLY FUNCTION",
        options: [{
            // MAX
            name: "rythm",
            description: "Secret token :0",
            type: ApplicationCommandOptionType.String,
            required: true
        }]
    },{ // SECRET
        name: "secret",
        description: "Behold …Oyster's secrets… one in which only a few really know of...",
        options: [{
            // KEY
            name: "key",
            description: "The key to Oyster's secrets— do you know it?!? :0",
            type: ApplicationCommandOptionType.String,
            required: true
        },{
            // Curious
            name: "curious",
            description: "I bet you're curious what this means",
            type: ApplicationCommandOptionType.String,
            required: false
        }]
    }
